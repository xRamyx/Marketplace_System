...
public class HistoryController  {
    ...
    @FXML
    private TableColumn<Transaction, Float> blncAft;

    @FXML
    private TableColumn<Transaction, Float> blncBef;

    @FXML
    private TableColumn<Transaction, String> prodName;

    @FXML
    private TableColumn<Transaction, Integer> prodQty;
...
//        new Transaction(200,300,"Apple", 3),
//        new Transaction(400,500,"Milk", 4)
//    );

//    @Override
//    public void initialize(URL url, ResourceBundle rb) {
//
//        blncBef.setCellValueFactory(new PropertyValueFactory<Transaction, Float>("balanceBefore"));
//
//        blncAft.setCellValueFactory(new PropertyValueFactory<Transaction, Float>("balanceAfter"));
//
//        prodName.setCellValueFactory(new PropertyValueFactory<Transaction, String>("name"));
//
//        prodQty.setCellValueFactory(new PropertyValueFactory<Transaction, Integer>("quantity"));
//
...
//        String dist = "Get-History";
//        JSONObject serverResponse = socketClient.socketSendReceiveJSON(json, dist);
//        String result = "";
//        int size = Integer.parseInt((String) serverResponse.get("size"));
//        ObservableList<Transaction> T = FXCollections.observableArrayList();
//        for(int i=0;i<size;i++){
//            //if(serverResponse.get("Bb"+ String.valueOf(i)) != serverResponse.get("Bb"+ String.valueOf(i+1))){
//            Transaction obj = new Transaction();
//            obj.setBalanceBefore(Float.parseFloat((String) serverResponse.get("Bb"+String.valueOf(i))));
//            obj.setBalanceAfter(Float.parseFloat((String) serverResponse.get("Ba"+String.valueOf(i))));
//            obj.setName((String) serverResponse.get("N" + String.valueOf(i)));
//            obj.setQuantity(Integer.valueOf((String) serverResponse.get("Q" + String.valueOf(i))));
//            T.add(obj);
//        }
//        return T;
//    }
